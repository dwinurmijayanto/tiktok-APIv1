...
try {
    ...
    if (empty($url)) {
        echo json_encode([
            ...
            'usage' => [
                'Full URL' => 'GET /api/tiktok?url=https://www.tiktok.com/@username/video/7347080009141587201',
                'Video ID' => 'GET /api/tiktok?url=7347080009141587201',
                'Short URL' => 'GET /api/tiktok?url=https://vm.tiktok.com/ZSFsqLc9X/'
            ],
            'features' => [
